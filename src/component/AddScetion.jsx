    ...
    <div className='w-full'>
       <div className='flex py-8 px-3 sm:px-10 justify-between'>
          ...
          <div className='flex gap-2'>
            <div className='border-gray-500 flex border rounded-lg items-center px-1 sm:px-2 py-1 text-sm'><button className='hidden sm:block'>Add widget</button> <span><Plus color="#7e8286" strokeWidth={3} height={16} /></span></div>
